...
//     const res = await api.get<ApiResponse<PageResponse<OutboundOrder>>>(
//       `/api/outbound-orders?${queryParams.toString()}`
//     );
...
//     const res = await api.get<ApiResponse<OutboundOrder>>(
//       `/api/outbound-orders/${orderId}`
//     );
//     return res.data.data;
//   },
...
//     const res = await api.post<ApiResponse<OutboundOrder>>(
//       "/api/outbound-orders",
//       data
//     );
//     return res.data.data;
...
//     const res = await api.put<ApiResponse<OutboundOrder>>(
//       `/api/outbound-orders/${orderId}/confirm`
//     );
//     return res.data.data;
//   },
...
//     const res = await api.put<ApiResponse<OutboundOrder>>(
//       `/api/outbound-orders/${orderId}/cancel`,
//       null,
//       { params: { reason } }
//     );
//     return res.data.data;
