...
public class InboundProcessTest {
    ...
    @Mock
    private IPurchaseOrderRepository poRepo;
    @Mock
    ...
    @Mock
    private IInboundNoteRepository inboundNoteRepo;
    @Mock
    private IInventoryRepository inventoryRepo;
    @Mock
    private ILocationRepository locationRepo;
    @Mock
    private IIboundDetailRepository inboundDetailRepo;
    @Mock
    ...
    void TC_IN_01_ImportPoFromExcel() throws Exception {
        ...
        itemB.setSku("SP_B");
        itemB.setQuantity(50);
        excelItems.add(itemA);
        excelItems.add(itemB);
    ...
    void TC_IN_05_PutAway() {
        ...
        verify(inventoryRepo)
                .save(argThat(inv -> inv.getLocation().getCode().equals("A-01-01") && inv.getQuantity() == 100));
    ...
    private PurchaseOrder createMockPo(Long id) {
        ...
        d1.setProduct(productA);
        d1.setExpectedQty(100);
        d1.setPurchaseOrder(po);
        PODetail d2 = new PODetail();
        d2.setProduct(productB);
        d2.setExpectedQty(50);
        d2.setPurchaseOrder(po);
        details.add(d1);
        details.add(d2);
